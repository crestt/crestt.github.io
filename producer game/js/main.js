...
app = new Vue({
    ...
    data:{
        ...
        cover:{
            status:'in',
            "animation-in":{
                'title-bg':'opacityChange delay0-2',
                'title':'littleBottomIn delay0-3',
                'li1':'littleBottomIn delay0-5',
                'li2':'littleBottomIn delay0-6',
                'li3':'littleBottomIn delay0-7',
                'li4':'littleBottomIn delay0-8',
                'li5':'littleBottomIn delay0-9',
                'p1': 'shortUp delay1-0',
                'p2': 'lineLeftIn delay1-1',
                'p3': 'down delay1-3',
                'p4': 'lineRightIn delay1-6',
                'p5': 'shortDown delay1-8',
                'icon': 'opacityChange delay1-9'
            },
            'animation-out':{
                'title-bg':'opacityChangeOut delay0',
                'title':'littleBottomOut delay0',
                'li1':'littleBottomOut delay0',
                'li2':'littleBottomOut delay0',
                'li3':'littleBottomOut delay0',
                'li4':'littleBottomOut delay0',
                'li5':'littleBottomOut delay0',
                'p1': 'littleBottomOut delay0',
                'p2': 'littleBottomOut delay0',
                'p3': 'littleBottomOut delay0',
                'p4': 'littleBottomOut delay0',
                'p5': 'littleBottomOut delay0',
                'icon': 'opacityChangeOut delay0'
            }
        },
        page0:{
            status:'in',
